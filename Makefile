...
build-bkctl:
	cd cmd/bkctl && go build -ldflags "-X github.com/achyuthnsamudrala/bulkhead/cmd/bkctl/internal/cli.version=$$(git describe --tags --always 2>/dev/null || echo dev) -X github.com/achyuthnsamudrala/bulkhead/cmd/bkctl/internal/cli.commit=$$(git rev-parse --short HEAD 2>/dev/null || echo unknown) -X github.com/achyuthnsamudrala/bulkhead/cmd/bkctl/internal/cli.date=$$(date -u +%Y-%m-%dT%H:%M:%SZ)" -o ../../bkctl .
